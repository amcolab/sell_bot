                          ...
                          render={({ field }) => (
                            <div>
                              <Input
                                ...
                                value={field.value ? `${field.value}` : ""}
                                error={
                                  errors.subsidiaries?.[index]?.industry?.revenuePercentage1
                                    ?.message
                                }
                                onchange={(e) => {
                                  const value = e.target.value.replace(/[^\d]/g, "");
                          ...
                          render={({ field }) => (
                            <div>
                              <Input
                                ...
                                value={field.value ? `${field.value}` : ""}
                                error={
                                  errors.subsidiaries?.[index]?.industry?.revenuePercentage2
                                    ?.message
                                }
                                onchange={(e) => {
                                  const value = e.target.value.replace(/[^\d]/g, "");
                                ...
                                render={({ field }) => (
                                  <div>
                                    <Input
                                      ...
                                      value={field.value ? `${field.value}` : ""}
                                      error={
                                        errors.subsidiaries?.[index]?.industry?.revenuePercentage3
                                          ?.message
                                      }
                                      onchange={(e) => {
                                        const value = e.target.value.replace(/[^\d]/g, "");
                    ...
                    render={({ field }) => (
                      <div>
                        <Input
                          ...
                          placeholder="利益を入力してください（単位：円）"
                          value={
                            field.value ? `¥${formatNumber(field.value)}` : "¥0"
                          }
                          error={
